...
if human_exist:
	...
	human_robot_distances = human_robot_distance.flatten()
	counts, bins = np.histogram(human_robot_distances,bins=50)
	total_number = len(human_robot_distances)
	num_smaller_than_safety_distance = len(human_robot_distances[human_robot_distances < safety_distance_human])
