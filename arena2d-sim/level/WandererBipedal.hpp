 ...
 * whichWanderer may be used to retrieve the corresponding Wanderer-object when checking for collisions etc.
 */
class WandererBipedal{
public:
	/* constructor
